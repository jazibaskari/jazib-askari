...
const SkillsSection = ({ trigger }: SkillsSectionProps) => {
  ...
  return (
    <Section id="skills">
      ...
      <Box
        sx={{ display: "flex", flexWrap: "wrap", gap: 1, mb: 6, width: "100%" }}
      >
        {skills.map((cat) => (
          <Chip
            key={cat.id}
            ...
            sx={{
              ...theme.typography.h4,
              backgroundColor: activeFilters.includes(cat.id)
                ? cat.color
                : "default",
              "&:hover": {
                backgroundColor: activeFilters.includes(cat.id)
              ...
              color: activeFilters.includes(cat.id)
                ? "white"
          ...
          return (
            ...
            >
              ...
              >
                <Typography
                  variant="h3"
                  sx={{ mb: 1, color: "text.quarternary" }}
                >
                  {cat.label}
                </Typography>
                <Typography
                  variant="body2"
                  sx={{ color: "text.grey", mb: 2.5, flex: 1 }}
                >
                  {cat.description}
                </Typography>
